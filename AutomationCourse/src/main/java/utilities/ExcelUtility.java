...
public class ExcelUtility {
	...
	{
		f=new FileInputStream("C:\\Users\\Lenovo\\git\\AutomationCourse_Repo\\AutomationCourse\\src\\test\\resources\\TestData.xlsx");
	...
	public static String getIntegerData(int a,int b,String sheet) throws IOException { //to convert to string, use String.valueOf(y);
		f=new FileInputStream("C:\\Users\\Lenovo\\git\\AutomationCourse_Repo\\AutomationCourse\\src\\test\\resources\\TestData.xlsx");
		w=new XSSFWorkbook(f);
		s=w.getSheet(sheet);
		XSSFRow r=s.getRow(a);
